...
(define_mode_iterator V_WHOLE [
  ...
  (RVVM8BF "TARGET_ZVFBFMIN || TARGET_BF16") (RVVM4BF "TARGET_ZVFBFMIN || TARGET_BF16")
  (RVVM2BF "TARGET_ZVFBFMIN || TARGET_BF16") (RVVM1BF "TARGET_ZVFBFMIN || TARGET_BF16")
...
(define_mode_iterator V_FRACT [
  ...
  (RVVMF2BF "TARGET_ZVFBFMIN") (RVVMF4BF "TARGET_ZVFBFMIN && TARGET_MIN_VLEN > 32")
...
(define_mode_iterator VWEXTBF [
  (RVVM8SF "TARGET_VECTOR_ELEN_FP_32") (RVVM4SF "TARGET_VECTOR_ELEN_FP_32") (RVVM2SF "TARGET_VECTOR_ELEN_FP_32")
  (RVVM1SF "TARGET_VECTOR_ELEN_FP_32") (RVVMF2SF "TARGET_VECTOR_ELEN_FP_32 && TARGET_MIN_VLEN > 32")
])

(define_mode_iterator VBF16 [
  (RVVM8BF "(TARGET_ZVFBFMIN || TARGET_BF16)")
  (RVVM4BF "(TARGET_ZVFBFMIN || TARGET_BF16)")
  (RVVM2BF "(TARGET_ZVFBFMIN || TARGET_BF16)")
  (RVVM1BF "(TARGET_ZVFBFMIN || TARGET_BF16)")
  (RVVMF2BF "(TARGET_ZVFBFMIN || TARGET_BF16)")
  (RVVMF4BF "(TARGET_ZVFBFMIN || TARGET_BF16) && TARGET_MIN_VLEN > 32")
])
...
(define_int_iterator VFPMAD [UNSPEC_VFPMADT UNSPEC_VFPMADB])

(define_int_attr tb [(UNSPEC_VFPMADT "t") (UNSPEC_VFPMADB "b")])
