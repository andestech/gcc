...
static const struct riscv_builtin_description riscv_builtins[] = {
  ...
  DIRECT_DSP_BUILTIN (subv2hi3, subv2hi3, sub16,
  ...
  DIRECT_DSP_BUILTIN (ksubv2hi3, ksubv2hi3, ksub16,
  ...
  DIRECT_DSP_BUILTIN (cras16_1, cras16_1, cras16,
  ...
  DIRECT_DSP_BUILTIN (rcras16_1, rcras16_1, rcras16,
  ...
  DIRECT_DSP_BUILTIN (urcras16_1, urcras16_1, urcras16,
  ...
  DIRECT_DSP_BUILTIN (kcras16_1, kcras16_1, kcras16,
  ...
  DIRECT_DSP_BUILTIN (ukcras16_1, ukcras16_1, ukcras16,
  ...
  DIRECT_DSP_BUILTIN (crsa16_1, crsa16_1, crsa16,
  ...
  DIRECT_DSP_BUILTIN (rcrsa16_1, rcrsa16_1, rcrsa16,
  ...
  DIRECT_DSP_BUILTIN (urcrsa16_1, urcrsa16_1, urcrsa16,
  ...
  DIRECT_DSP_BUILTIN (kcrsa16_1, kcrsa16_1, kcrsa16,
  ...
  DIRECT_DSP_BUILTIN (ukcrsa16_1, ukcrsa16_1, ukcrsa16,
  ...
  DIRECT_DSP_BUILTIN (addv4qi3, addv4qi3, add8,
  ...
  DIRECT_DSP_BUILTIN (cmpeq16, cmpeq16, cmpeq16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, CMPEQ16),
  DIRECT_DSP_BUILTIN (cmpeq16, cmpeq16, v_scmpeq16,
		      RISCV_UV2HI_FTYPE_V2HI_V2HI, V_SCMPEQ16),
  DIRECT_DSP_BUILTIN (cmpeq16, cmpeq16, v_ucmpeq16,
		      RISCV_UV2HI_FTYPE_UV2HI_UV2HI, V_UCMPEQ16),
  DIRECT_DSP_BUILTIN (scmplt16, scmplt16, scmplt16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, SCMPLT16),
  DIRECT_DSP_BUILTIN (scmplt16, scmplt16, v_scmplt16,
		      RISCV_UV2HI_FTYPE_V2HI_V2HI, V_SCMPLT16),
  DIRECT_DSP_BUILTIN (scmple16, scmple16, scmple16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, SCMPLE16),
  DIRECT_DSP_BUILTIN (scmple16, scmple16, v_scmple16,
		      RISCV_UV2HI_FTYPE_V2HI_V2HI, V_SCMPLE16),
  DIRECT_DSP_BUILTIN (ucmplt16, ucmplt16, ucmplt16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, UCMPLT16),
  DIRECT_DSP_BUILTIN (ucmplt16, ucmplt16, v_ucmplt16,
		      RISCV_UV2HI_FTYPE_UV2HI_UV2HI, V_UCMPLT16),
  DIRECT_DSP_BUILTIN (ucmple16, ucmple16, ucmple16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, UCMPLE16),
  DIRECT_DSP_BUILTIN (ucmple16, ucmple16, v_ucmple16,
		      RISCV_UV2HI_FTYPE_UV2HI_UV2HI, V_UCMPLE16),
  /* DSP Extension: 8bit Compare.  */
  DIRECT_DSP_BUILTIN (cmpeq8, cmpeq8, cmpeq8,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, CMPEQ8),
  DIRECT_DSP_BUILTIN (cmpeq8, cmpeq8, v_scmpeq8,
		      RISCV_UV4QI_FTYPE_V4QI_V4QI, V_SCMPEQ8),
  DIRECT_DSP_BUILTIN (cmpeq8, cmpeq8, v_ucmpeq8,
		      RISCV_UV4QI_FTYPE_UV4QI_UV4QI, V_UCMPEQ8),
  DIRECT_DSP_BUILTIN (scmplt8, scmplt8, scmplt8,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, SCMPLT8),
  DIRECT_DSP_BUILTIN (scmplt8, scmplt8, v_scmplt8,
		      RISCV_UV4QI_FTYPE_V4QI_V4QI, V_SCMPLT8),
  DIRECT_DSP_BUILTIN (scmple8, scmple8, scmple8,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, SCMPLE8),
  DIRECT_DSP_BUILTIN (scmple8, scmple8, v_scmple8,
		      RISCV_UV4QI_FTYPE_V4QI_V4QI, V_SCMPLE8),
  DIRECT_DSP_BUILTIN (ucmplt8, ucmplt8, ucmplt8,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, UCMPLT8),
  DIRECT_DSP_BUILTIN (ucmplt8, ucmplt8, v_ucmplt8,
		      RISCV_UV4QI_FTYPE_UV4QI_UV4QI, V_UCMPLT8),
  DIRECT_DSP_BUILTIN (ucmple8, ucmple8, ucmple8,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, UCMPLE8),
  DIRECT_DSP_BUILTIN (ucmple8, ucmple8, v_ucmple8,
		      RISCV_UV4QI_FTYPE_UV4QI_UV4QI, V_UCMPLE8),
  /* DSP Extension: SIMD 16bit MISC.  */
  DIRECT_DSP_BUILTIN (sminv2hi3, sminv2hi3, smin16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, SMIN16),
  DIRECT_DSP_BUILTIN (sminv2hi3, sminv2hi3, v_smin16,
		      RISCV_V2HI_FTYPE_V2HI_V2HI, V_SMIN16),
  DIRECT_DSP_BUILTIN (uminv2hi3, uminv2hi3, umin16,
  ...
  DIRECT_DSP_BUILTIN (sclip16, sclip16, sclip16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, SCLIP16),
  DIRECT_DSP_BUILTIN (sclip16, sclip16, v_sclip16,
		      RISCV_V2HI_FTYPE_V2HI_ULONG, V_SCLIP16),
  DIRECT_DSP_BUILTIN (uclip16, uclip16, uclip16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, UCLIP16),
  DIRECT_DSP_BUILTIN (uclip16, uclip16, v_uclip16,
		      RISCV_V2HI_FTYPE_V2HI_ULONG, V_UCLIP16),
  DIRECT_DSP_BUILTIN (khm16, khm16, khm16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, KHM16),
  DIRECT_DSP_BUILTIN (khm16, khm16, v_khm16,
		      RISCV_V2HI_FTYPE_V2HI_V2HI, V_KHM16),
  DIRECT_DSP_BUILTIN (khmx16, khmx16, khmx16,
		      RISCV_ULONG_FTYPE_ULONG_ULONG, KHMX16),
  DIRECT_DSP_BUILTIN (khmx16, khmx16, v_khmx16,
