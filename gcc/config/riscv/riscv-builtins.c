...
static const struct riscv_builtin_description riscv_builtins[] = {
  ...
  DIRECT_DSP_BUILTIN (kdmbb, kdmbb64, kdmbb,
		      RISCV_LONG_FTYPE_USI_USI, KDMBB),
  DIRECT_DSP_BUILTIN (kdmbb, kdmbb64, v_kdmbb,
		      RISCV_LONG_FTYPE_V2HI_V2HI, V_KDMBB),
  DIRECT_DSP_BUILTIN (kdmbt, kdmbt64, kdmbt,
		      RISCV_LONG_FTYPE_USI_USI, KDMBT),
  DIRECT_DSP_BUILTIN (kdmbt, kdmbt64, v_kdmbt,
		      RISCV_LONG_FTYPE_V2HI_V2HI, V_KDMBT),
  DIRECT_DSP_BUILTIN (kdmtt, kdmtt64, kdmtt,
		      RISCV_LONG_FTYPE_USI_USI, KDMTT),
  DIRECT_DSP_BUILTIN (kdmtt, kdmtt64, v_kdmtt,
