...
static const struct riscv_builtin_description riscv_builtins[] = {
  ...
  DIRECT_DSP_BUILTIN (khmbb, khmbb64, khmbb,
		      RISCV_LONG_FTYPE_USI_USI, KHMBB),
  DIRECT_DSP_BUILTIN (khmbb, khmbb64, v_khmbb,
		      RISCV_LONG_FTYPE_V2HI_V2HI, V_KHMBB),
  DIRECT_DSP_BUILTIN (khmbt, khmbt64, khmbt,
		      RISCV_LONG_FTYPE_USI_USI, KHMBT),
  DIRECT_DSP_BUILTIN (khmbt, khmbt64, v_khmbt,
		      RISCV_LONG_FTYPE_V2HI_V2HI, V_KHMBT),
  DIRECT_DSP_BUILTIN (khmtt, khmtt64, khmtt,
		      RISCV_LONG_FTYPE_USI_USI, KHMTT),
  DIRECT_DSP_BUILTIN (khmtt, khmtt64, v_khmtt,
