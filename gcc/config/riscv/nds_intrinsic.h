...
#define __nds__clmul(a, b) \
  (__builtin_riscv_clmul (a, b))
#define __nds__clmulh(a, b) \
  (__builtin_riscv_clmulh (a, b))
#define __nds__clmulr(a, b) \
  (__builtin_riscv_clmulr (a, b))
...
#define vfwcvtsbf16_bf16m1(src) __riscv_vfwcvtbf16_f_bf_v_f32m2((src), 0)
#define vfwcvtsbf16_bf16m2(src) __riscv_vfwcvtbf16_f_bf_v_f32m4((src), 0)
#define vfwcvtsbf16_bf16m4(src) __riscv_vfwcvtbf16_f_bf_v_f32m8((src), 0)
#define vfncvtbf16s_bf16m1(src) __riscv_vfncvtbf16_bf_f_w_bf16m1((src), 0)
#define vfncvtbf16s_bf16m2(src) __riscv_vfncvtbf16_bf_f_w_bf16m2((src), 0)
#define vfncvtbf16s_bf16m4(src) __riscv_vfncvtbf16_bf_f_w_bf16m4((src), 0)
#endif
