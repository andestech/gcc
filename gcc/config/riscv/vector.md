...
(define_attr "has_vtype_op" "false,true"
  (cond [(eq_attr "type" "vlde,vste,vldm,vstm,vlds,vsts,\
			  ...
			  vssegtux,vssegtox,vlsegdff,vfpmad")
	 (const_string "true")]
	(const_string "false")))
...
(define_attr "ratio" ""
  (cond [(eq_attr "type" "vimov,vfmov,vldux,vldox,vstux,vstox,\
			  ...
			  vgather,vcompress,vlsegdux,vlsegdox,vssegtux,vssegtox,vfpmad")
	   (const_int INVALID_ATTRIBUTE)
...
(define_attr "vl_op_idx" ""
  (cond [(eq_attr "type" "vlde,vste,vimov,vfmov,vldm,vstm,vmalu,vsts,vstux,\
	 ...
	 (eq_attr "type" "vldux,vldox,vialu,vshift,viminmax,vimul,vidiv,vsalu,\
			  ...
			  vslideup,vslidedown,vislide1up,vislide1down,vfslide1up,vfslide1down,\
			  vgather,viwmuladd,vfwmuladd,vlsegds,vlsegdux,vlsegdox,vfpmad")
	   (const_int 5)
...
(define_attr "ta" ""
  (cond [(eq_attr "type" "vlde,vimov,vfmov,vext,vmiota,vfsqrt,vfrecp,\
	 ...
	 (eq_attr "type" "vldux,vldox,vialu,vshift,viminmax,vimul,vidiv,vsalu,\
			  ...
			  vlsegds,vlsegdux,vlsegdox,vfpmad")
	   (symbol_ref "riscv_vector::get_ta(operands[6])")
...
(define_attr "ma" ""
  (cond [(eq_attr "type" "vlde,vext,vmiota,vfsqrt,vfrecp,vfcvtitof,vfcvtftoi,\
	 ...
	 (eq_attr "type" "vldux,vldox,vialu,vshift,viminmax,vimul,vidiv,vsalu,\
			  ...
			  viwmuladd,vfwmuladd,vlsegds,vlsegdux,vlsegdox,vfpmad")
	   (symbol_ref "riscv_vector::get_ma(operands[7])")
...
(define_insn "@vsetvl<mode>_volatile"
  [(set (match_operand:P 0 "register_operand" "=r")
...
(define_insn "@pred_quad_mul_plus<su><mode>"
	...
	(if_then_else:VQEXTI
	  ...
	  (plus:VQEXTI
	    (mult:VQEXTI
	      ...
	      (any_extend:VQEXTI
	        (match_operand:<V_QUAD_TRUNC> 4 "register_operand" "   vr")))
	    (match_operand:VQEXTI 2 "register_operand"               "    0"))
	  (match_dup 2)))]
  "TARGET_VECTOR && TARGET_V5"
  "vqmacc<u>.vv\t%0,%3,%4%p1"
  [(set_attr "type" "viwmuladd")
   (set_attr "mode" "<V_QUAD_TRUNC>")])

(define_insn "@pred_quad_mul_plus<su><mode>_scalar"
  [(set (match_operand:VQEXTI 0 "register_operand"                    "=&vr")
	(if_then_else:VQEXTI
	  (unspec:<VM>
	    [(match_operand:<VM> 1 "vector_mask_operand"             "vmWc1")
	  ...
	  (plus:VQEXTI
	    (mult:VQEXTI
	      (any_extend:VQEXTI
	        (vec_duplicate:<V_QUAD_TRUNC>
	          (match_operand:<VQSUBEL> 3 "register_operand"       "    r")))
	      (any_extend:VQEXTI
	        (match_operand:<V_QUAD_TRUNC> 4 "register_operand" "   vr")))
	    (match_operand:VQEXTI 2 "register_operand"               "    0"))
	  (match_dup 2)))]
  "TARGET_VECTOR && TARGET_V5"
  "vqmacc<u>.vx\t%0,%3,%4%p1"
  [(set_attr "type" "viwmuladd")
   (set_attr "mode" "<V_QUAD_TRUNC>")])

(define_insn "@pred_quad_mul_plussu<mode>"
  [(set (match_operand:VQEXTI 0 "register_operand"                    "=&vr")
	(if_then_else:VQEXTI
	  (unspec:<VM>
	    [(match_operand:<VM> 1 "vector_mask_operand"             "vmWc1")
	  ...
	  (match_dup 2)))]
  "TARGET_VECTOR && TARGET_V5"
  "vqmaccsu.vv\t%0,%3,%4%p1"
  [(set_attr "type" "viwmuladd")
   (set_attr "mode" "<V_QUAD_TRUNC>")])

(define_insn "@pred_quad_mul_plussu<mode>_scalar"
  [(set (match_operand:VQEXTI 0 "register_operand"                    "=&vr")
	(if_then_else:VQEXTI
	  (unspec:<VM>
	    [(match_operand:<VM> 1 "vector_mask_operand"             "vmWc1")
	  ...
	  (match_dup 2)))]
  "TARGET_VECTOR && TARGET_V5"
  "vqmaccsu.vx\t%0,%3,%4%p1"
  [(set_attr "type" "viwmuladd")
   (set_attr "mode" "<V_QUAD_TRUNC>")])

(define_insn "@pred_quad_mul_plusus<mode>_scalar"
  [(set (match_operand:VQEXTI 0 "register_operand"                    "=&vr")
	(if_then_else:VQEXTI
	  (unspec:<VM>
	    [(match_operand:<VM> 1 "vector_mask_operand"             "vmWc1")
	  ...
	  (match_dup 2)))]
  "TARGET_VECTOR && TARGET_V5"
  "vqmaccus.vx\t%0,%3,%4%p1"
  [(set_attr "type" "viwmuladd")
   (set_attr "mode" "<V_QUAD_TRUNC>")])

(define_insn "@pred_vd4dot<su><mode>"
  [(set (match_operand:VQEXTI 0 "register_operand"                    "=&vr")
	(if_then_else:VQEXTI
	  (unspec:<VM>
	    [(match_operand:<VM> 1 "vector_mask_operand"             "vmWc1")
	  ...
	  (unspec:VQEXTI
	    [(any_extend:VQEXTI
	       (match_operand:VQEXTI 3 "register_operand" " vr"))
	     (any_extend:VQEXTI
	       (match_operand:VQEXTI 4 "register_operand" " vr"))
	     (any_extend:VQEXTI
	       (match_operand:VQEXTI 2 "register_operand" " 0"))] UNSPEC_VD4DOT)
	  (match_dup 2)))]
  "TARGET_VECTOR && TARGET_V5"
  "vd4dot<su>.vv\t%0,%3,%4%p1"
  [(set_attr "type" "viwmuladd")
   (set_attr "mode" "<MODE>")])

(define_insn "@pred_vd4dotsu<mode>"
  [(set (match_operand:VQEXTI 0 "register_operand"                    "=&vr")
	(if_then_else:VQEXTI
	  (unspec:<VM>
	    [(match_operand:<VM> 1 "vector_mask_operand"             "vmWc1")
...
(define_insn "@pred_vfpmad<tb><mode>"
  ...
  "TARGET_ZVFH && TARGET_V5"
  "vfpmad<tb>.vf\t%0,%4,%3%p1"
  [(set_attr "type" "vfpmad")
   (set_attr "mode" "<MODE>")
   (set (attr "frm_mode")
	(symbol_ref "riscv_vector::get_frm_mode (operands[9])"))])

(define_insn "@pred_widen_mul_plus_bf<mode>_scalar"
...
(define_insn "@pred_widen_mul_plus_bf<mode>"
  [(set (match_operand:VWEXTBF 0 "register_operand"                    "=&vr")
	(if_then_else:VWEXTBF
	  (unspec:<VM>
	    [(match_operand:<VM> 1 "vector_mask_operand"             "vmWc1")
...
(define_expand "mov<mode>"
  [(set (match_operand:VBF16 0 "reg_or_mem_operand")
	(match_operand:VBF16 1 "general_operand"))]
  "TARGET_VECTOR"
{
  if (riscv_vector::legitimize_move (operands[0], operands[1]))
    DONE;
...
(define_insn_and_split "@pred_mov<mode>"
  [(set (match_operand:VBF16 0 "nonimmediate_operand"      "=vr,    vr,    vd,     m,    vr,    vr,    vr,    vr")
    (if_then_else:VBF16
      (unspec:<VM>
        [(match_operand:<VM> 1 "vector_mask_operand" "vmWc1,   Wc1,    vm, vmWc1,   Wc1,   Wc1,   Wc1,   Wc1")
         (match_operand 4 "vector_length_operand"    "   rK,    rK,    rK,    rK,    rK,    rK,    rK,    rK")
         ...
         (reg:SI VL_REGNUM)
         (reg:SI VTYPE_REGNUM)] UNSPEC_VPREDICATE)
      (match_operand:VBF16 3 "vector_move_operand"       "    m,     m,     m,    vr,    vr,    vr, viWc0, viWc0")
      (match_operand:VBF16 2 "vector_merge_operand"      "    0,    vu,    vu,    vu,    vu,     0,    vu,     0")))]
  "TARGET_VECTOR && TARGET_ZVFBFMIN && (MEM_P (operands[0]) || MEM_P (operands[3])
   || CONST_VECTOR_P (operands[1]))"
  "@
   vle<sew>.v\t%0,%3%p1
   vle<sew>.v\t%0,%3
...
(define_insn "@pred_extend_bf<mode>"
...
(define_insn "@pred_trunc_bf16<mode>"
  [(set (match_operand:<V_DOUBLE_TRUNC_BF> 0 "register_operand"       "=vd, vd, vr, vr,  &vr,  &vr")
	(if_then_else:<V_DOUBLE_TRUNC_BF>
	  ...
	  (float_truncate:<V_DOUBLE_TRUNC_BF>
	     (match_operand:VWEXTBF 3 "register_operand"            "  0,  0,  0,  0,   vr,   vr"))
...
(define_expand "@vreinterpret<mode>"
  [(set (match_operand:VBF16 0 "register_operand")
	(match_operand 1 "vector_any_register_operand"))]
  "TARGET_VECTOR && TARGET_ZVFBFMIN"
  {
    emit_move_insn (operands[0], gen_lowpart (<MODE>mode, operands[1]));
...
(define_insn "@vfwcvt_bf16<mode>"
  [(set (match_operand:VWEXTBF 0 "register_operand"                  "=&vr")
	(unspec_volatile:VWEXTBF
	  [(float_extend:VWEXTBF
	     (match_operand:<V_DOUBLE_TRUNC_BF> 1 "register_operand" "  vr"))] UNSPEC_VFCVTBF16))]
  "TARGET_VECTOR && TARGET_BF16"
  "vfwcvt.s.bf16\t%0,%1"
  [(set_attr "mode" "<V_DOUBLE_TRUNC_BF>")])

(define_insn "@vfncvt_bf16<mode>"
  [(set (match_operand:<V_DOUBLE_TRUNC_BF> 0 "register_operand"   "=&vr")
	(unspec_volatile:<V_DOUBLE_TRUNC_BF>
	  [(float_truncate:<V_DOUBLE_TRUNC_BF>
	     (match_operand:VWEXTBF 1 "register_operand"          "  vr"))] UNSPEC_VFCVTBF16))]
  "TARGET_VECTOR && TARGET_BF16"
  "vfncvt.bf16.s\t%0,%1"
  [(set_attr "mode" "<V_DOUBLE_TRUNC_BF>")])
