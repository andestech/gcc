...
(define_mode_iterator DSP_VHI [(V2HI "!TARGET_64BIT") (V4HI "TARGET_64BIT")])

(define_mode_iterator DSP_VQI [(V4QI "!TARGET_64BIT") (V8QI "TARGET_64BIT")])
...
(define_expand "vcras16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vcras16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])

(define_insn "cras16_64_le"
  [(set (subreg:V4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:V4HI
	  (vec_concat:V2HI
	    (minus:HI (vec_select:HI (subreg:V4HI (match_operand:DI 1 "register_operand" " r") 0)
				     (parallel [(const_int 0)]))
		      (vec_select:HI (subreg:V4HI (match_operand:DI 2 "register_operand" " r") 0)
				     (parallel [(const_int 1)])))
	    (plus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)]))
		     (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:V2HI
	    (minus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 2)]))
		      (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (plus:HI  (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 3)]))
		      (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "cras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
   (set_attr "mode" "V4HI")])

(define_insn "vcras16_64_le"
...
(define_expand "vkcras16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vkcras16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_insn "kcras16_64_le"
  [(set (subreg:V4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:V4HI
	  (vec_concat:V2HI
	    (ss_minus:HI (vec_select:HI (subreg:V4HI (match_operand:DI 1 "register_operand" " r") 0)
					(parallel [(const_int 0)]))
			 (vec_select:HI (subreg:V4HI (match_operand:DI 2 "register_operand" " r") 0)
					(parallel [(const_int 1)])))
	    (ss_plus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)]))
			(vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:V2HI
	    (ss_minus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 2)]))
			 (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (ss_plus:HI  (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 3)]))
			 (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "kcras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_expand "vukcras16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP"
{
  emit_insn (gen_vukcras16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_insn "ukcras16_64_le"
  [(set (subreg:V4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:V4HI
	  (vec_concat:V2HI
	    (us_minus:HI (vec_select:HI (subreg:V4HI (match_operand:DI 1 "register_operand" " r") 0)
					(parallel [(const_int 0)]))
			 (vec_select:HI (subreg:V4HI (match_operand:DI 2 "register_operand" " r") 0)
					(parallel [(const_int 1)])))
	    (us_plus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)]))
			(vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:V2HI
	    (us_minus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 2)]))
			 (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (us_plus:HI  (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 3)]))
			 (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "ukcras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_expand "vcrsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vcrsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_insn "crsa16_64_le"
  [(set (subreg:V4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:V4HI
	  (vec_concat:V2HI
	    (plus:HI (vec_select:HI (subreg:V4HI (match_operand:DI 1 "register_operand" " r") 0)
				    (parallel [(const_int 0)]))
		     (vec_select:HI (subreg:V4HI (match_operand:DI 2 "register_operand" " r") 0)
				    (parallel [(const_int 1)])))
	    (minus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)]))
		      (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:V2HI
	    (plus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 2)]))
		     (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (minus:HI  (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 3)]))
		       (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "crsa16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_expand "vkcrsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vkcrsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_insn "kcrsa16_64_le"
  [(set (subreg:V4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:V4HI
	  (vec_concat:V2HI
	    (ss_plus:HI (vec_select:HI (subreg:V4HI (match_operand:DI 1 "register_operand" " r") 0)
				       (parallel [(const_int 0)]))
			(vec_select:HI (subreg:V4HI (match_operand:DI 2 "register_operand" " r") 0)
				       (parallel [(const_int 1)])))
	    (ss_minus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)]))
			 (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:V2HI
	    (ss_plus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 2)]))
			(vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (ss_minus:HI  (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 3)]))
			  (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "kcrsa16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_expand "vukcrsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vukcrsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_insn "ukcrsa16_64_le"
  [(set (subreg:V4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:V4HI
	  (vec_concat:V2HI
	    (us_plus:HI (vec_select:HI (subreg:V4HI (match_operand:DI 1 "register_operand" " r") 0)
				       (parallel [(const_int 0)]))
			(vec_select:HI (subreg:V4HI (match_operand:DI 2 "register_operand" " r") 0)
				       (parallel [(const_int 1)])))
	    (us_minus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)]))
			 (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
	  (vec_concat:V2HI
	    (us_plus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 2)]))
			(vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 3)])))
	    (us_minus:HI  (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 3)]))
			  (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 2)]))))))]
  "TARGET_DSP && TARGET_64BIT"
  "ukcrsa16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_expand "vrcras16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vrcras16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
	...
	(vec_concat:V4HI
	  (vec_concat:V2HI
	    (truncate:HI
	      (ashiftrt:SI
		(minus:SI
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_operand:DI 1 "register_operand" " r") 0)
						 (parallel [(const_int 0)])))
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_operand:DI 2 "register_operand" " r") 0)
						  (parallel [(const_int 1)]))))
		(const_int 1)))
	    (truncate:HI
	      (ashiftrt:SI
		(plus:SI
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)])))
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
		(const_int 1))))
	  (vec_concat:V2HI
	    (truncate:HI
	      (ashiftrt:SI
		(minus:SI
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 2)])))
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 3)]))))
		(const_int 1)))
	    (truncate:HI
	      (ashiftrt:SI
		(plus:SI
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 3)])))
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 2)]))))
		(const_int 1))))))]
  "TARGET_DSP && TARGET_64BIT"
  "rcras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_expand "vurcras16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vurcras16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
	...
	(vec_concat:V4HI
	  (vec_concat:V2HI
	    (truncate:HI
	      (lshiftrt:SI
		(minus:SI
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_operand:DI 1 "register_operand" " r") 0)
						 (parallel [(const_int 0)])))
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_operand:DI 2 "register_operand" " r") 0)
						  (parallel [(const_int 1)]))))
		(const_int 1)))
	    (truncate:HI
	      (lshiftrt:SI
		(plus:SI
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)])))
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 0)]))))
		(const_int 1))))
	  (vec_concat:V2HI
	    (truncate:HI
	      (lshiftrt:SI
		(minus:SI
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 2)])))
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 3)]))))
		(const_int 1)))
	    (truncate:HI
	      (lshiftrt:SI
		(plus:SI
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 3)])))
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 2)]))))
		(const_int 1))))))]
  "TARGET_DSP && TARGET_64BIT"
  "urcras16\t%0, %1, %2"
  [(set_attr "type" "dalu")
...
(define_expand "vrcrsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vrcrsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_expand "vurcrsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vurcrsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_expand "<shift><mode>3"
  [(set (match_operand:DSP_VHI 0 "register_operand"                "")
	(any_shift:DSP_VHI (match_operand:DSP_VHI 1 "register_operand" "")
...
(define_insn "*ashl<mode>3"
  [(set (match_operand:DSP_VHI 0 "register_operand"             "=  r, r")
	(ashift:DSP_VHI (match_operand:DSP_VHI 1 "register_operand" "   r, r")
...
(define_insn "kslli16<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand"                "=  r, r")
	(ss_ashift:DSP_VHI (match_operand:DSP_VHI 1 "register_operand" "   r, r")
		       (match_operand:SI 2  "rimm4u_operand"   " u04, r")))]
  "TARGET_DSP"
  "@
   kslli16\t%0, %1, %2
...
(define_insn "*ashr<mode>3"
  [(set (match_operand:DSP_VHI 0 "register_operand"               "=   r, r")
	(ashiftrt:DSP_VHI (match_operand:DSP_VHI 1 "register_operand" "    r, r")
		      (match_operand:SI 2  "rimm4u_operand"   " u04, r")))]
  "TARGET_DSP"
  "@
   srai16\t%0, %1, %2
...
(define_insn "sra16_round<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand"                            "=  r, r")
	(unspec:DSP_VHI [(ashiftrt:DSP_VHI (match_operand:DSP_VHI 1 "register_operand" "   r, r")
				   (match_operand:SI 2  "rimm4u_operand"   " u04, r"))]
		     UNSPEC_ROUND))]
  "TARGET_DSP"
  "@
...
(define_insn "*lshr<mode>3"
  [(set (match_operand:DSP_VHI 0 "register_operand"               "=  r, r")
	(lshiftrt:DSP_VHI (match_operand:DSP_VHI 1 "register_operand" "   r, r")
		      (match_operand:SI 2  "rimm4u_operand"   " u04, r")))]
  "TARGET_DSP"
  "@
   srli16\t%0, %1, %2
...
(define_insn "srl16_round<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand"                            "=  r, r")
	(unspec:DSP_VHI [(lshiftrt:DSP_VHI (match_operand:DSP_VHI 1 "register_operand" "   r, r")
				   (match_operand:SI 2  "rimm4u_operand"   " u04, r"))]
		     UNSPEC_ROUND))]
  "TARGET_DSP"
  "@
...
(define_insn "sclip8<mode>"
  [(set (match_operand:DSP_VQI 0 "register_operand"              "=  r")
	(unspec:DSP_VQI [(match_operand:DSP_VQI 1 "register_operand" "   r")
...
(define_insn "sclip16<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand"              "=   r")
	(unspec:DSP_VHI [(match_operand:DSP_VHI 1 "register_operand" "    r")
...
(define_insn "khm16<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand"              "=r")
	(unspec:DSP_VHI [(match_operand:DSP_VHI 1 "reg_or_0_operand" " rJ")
		     (match_operand:DSP_VHI 2 "reg_or_0_operand" " rJ")]
		     UNSPEC_KHM))]
  "TARGET_DSP"
  "khm16\t%0, %z1, %z2"
  [(set_attr "type"   "dmul")
...
(define_insn "khm8<mode>"
  [(set (match_operand:DSP_VQI 0 "register_operand"              "=r")
	(unspec:DSP_VQI [(match_operand:DSP_VQI 1 "reg_or_0_operand" " rJ")
		     (match_operand:DSP_VQI 2 "reg_or_0_operand" " rJ")]
		     UNSPEC_KHM))]
  "TARGET_DSP"
  "khm8\t%0, %z1, %z2"
  [(set_attr "type"   "dmul")
...
(define_insn "vec_setv4qi_internal"
  [(set (match_operand:V4QI 0 "register_operand"    "=   r,    r,    r,    r")
	(vec_merge:V4QI
	  ...
	  (match_operand:SI 3 "imm_1_2_4_8_operand" " M01, M02, M04, M08")))]
  "TARGET_DSP && !TARGET_64BIT"
  "@
   insb\t%0, %1, 0
   insb\t%0, %1, 1
...
(define_insn "vec_set<mode>_internal"
  [(set (match_operand:VSHI 0 "register_operand"   "=  r,   r")
	(vec_merge:VSHI
	  ...
	  (match_operand:SI 3 "imm_1_2_operand"    " M01, M02")))]
  "TARGET_DSP"
  "@
   pktb<bits>\t%0, %2, %1
   pkbb<bits>\t%0, %1, %2"
...
(define_insn "vec_set<mode>_internal_1"
  [(set (match_operand:VSHI 0 "register_operand"   "=r")
	(vec_concat:VSHI
	    (match_operand:<VNHALF> 2 "register_operand" "   r")
	  (match_operand:<VNHALF> 1 "register_operand" "   r")))]
  "TARGET_DSP"
  "
   pkbb<bits>\t%0, %1, %2"
  [(set_attr "type"  "dpack")
	...
	(vec_merge:V2HI
	  ...
	  (vec_duplicate:V2HI
	    (vec_select:HI
	      ...
	      (parallel [(match_operand:SI 4 "imm_0_1_operand" " M00, M01, M00, M01")])))
	  (match_operand:SI 3 "imm_1_2_operand"                " M01, M01, M02, M02")))]
  "TARGET_DSP && !TARGET_64BIT"
  "@
   pkbb16\t%0, %2, %1
   pktb16\t%0, %2, %1
	...
	(vec_merge:VSHI
	  (vec_duplicate:VSHI
	    (vec_select:<VNHALF>
	      ...
	      (parallel [(match_operand:SI 4 "imm_0_1_operand" "M00, M00, M01, M01, M00, M00, M01, M01")])))
	  (vec_duplicate:VSHI
	    (vec_select:<VNHALF>
	      (match_operand:VSHI 2 "register_operand"         "  r,   r,   r,   r,   r,   r,   r,   r")
	      (parallel [(match_operand:SI 5 "imm_0_1_operand" "M00, M01, M01, M00, M00, M01, M01, M00")])))
	  (match_operand:SI 3 "imm_1_2_operand"                "M01, M01, M01, M01, M02, M02, M02, M02")))]
  "TARGET_DSP"
  "@
   pkbb<bits>\t%0, %2, %1
   pktb<bits>\t%0, %2, %1
...
(define_expand "vpkbb64"
  [(match_operand:V4HI 0 "register_operand")
   (match_operand:V4HI 1 "register_operand")
   (match_operand:V4HI 2 "register_operand")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vvec_pkbb64 (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dpack")])
...
(define_insn "vec_pkbb64"
  [(set (subreg:V4HI (match_operand:DI 0 "register_operand" "=r") 0)
	(vec_select:V4HI
	 (vec_concat:V8HI (subreg:V4HI (match_operand:DI 1 "register_operand" "r") 0)
			  (subreg:V4HI (match_operand:DI 2 "register_operand" "r") 0))
...
(define_expand "vpkbt64"
  [(match_operand:V4HI 0 "register_operand")
   (match_operand:V4HI 1 "register_operand")
   (match_operand:V4HI 2 "register_operand")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vvec_pkbt64 (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dpack")])
...
(define_expand "vpktt64"
  [(match_operand:V4HI 0 "register_operand")
   (match_operand:V4HI 1 "register_operand")
   (match_operand:V4HI 2 "register_operand")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vvec_pktt64 (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dpack")])
...
(define_expand "vpktb64"
  [(match_operand:V4HI 0 "register_operand")
   (match_operand:V4HI 1 "register_operand")
   (match_operand:V4HI 2 "register_operand")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vvec_pktb64 (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dpack")])
...
(define_expand "vsmbb"
  ...
  "TARGET_DSP && !TARGET_64BIT"
{
  emit_insn (gen_vmulhisi3v (operands[0], operands[1], operands[2],
			    GEN_INT (0), GEN_INT (0)));
  DONE;
}
[(set_attr "type" "dmul")])
...
(define_insn "mulhisi3v"
  [(set (match_operand:SI 0 "register_operand"                  "=  r,   r,   r,   r")
	(mult:SI
	  (sign_extend:SI
	     (vec_select:HI
	       (subreg:V2HI (match_operand:SI 1 "register_operand"         "   r,   r,   r,   r") 0)
	       (parallel [(match_operand:SI 3 "imm_0_1_operand" " M00, M00, M01, M01")])))
	  (sign_extend:SI (vec_select:HI
	       (subreg:V2HI (match_operand:SI 2 "register_operand"         "   r,   r,   r,   r") 0)
	       (parallel [(match_operand:SI 4 "imm_0_1_operand" " M00, M01, M01, M00")])))))]
  "TARGET_DSP && !TARGET_64BIT"
{
...
(define_expand "vsmbb64"
  [(match_operand:V2SI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vmulv2hiv2si3v (operands[0], operands[1], operands[2],
				GEN_INT (0), GEN_INT (2), GEN_INT (0), GEN_INT (2)));
  DONE;
}
[(set_attr "type" "dmul")])
...
(define_insn "mulv2hiv2si3v"
  [(set (subreg:V2SI (match_operand:DI 0 "register_operand" "=r, r, r") 0)
        (mult:V2SI
	 (sign_extend:V2SI
	  (vec_select:V2HI
	   (subreg:V4HI (match_operand:DI 1 "register_operand" "r, r, r") 0)
	   (parallel [(match_operand:SI 3 "imm2u_operand" " M00, M00, M01")
		      (match_operand:SI 4 "imm2u_operand" " M02, M02, M03")])))
	 (sign_extend:V2SI
	  (vec_select:V2HI
	   (subreg:V4HI (match_operand:DI 2 "register_operand" "r, r, r") 0)
	   (parallel [(match_operand:SI 5 "imm2u_operand" " M00, M01, M01")
		      (match_operand:SI 6 "imm2u_operand" " M02, M03, M03")])))))]
  "TARGET_DSP && TARGET_64BIT"
  "@
   smbb16\t%0, %1, %2
   smbt16\t%0, %1, %2
...
(define_expand "vsmbb32"
  [(match_operand:DI 0 "register_operand" "")
   (match_operand:V2SI 1 "register_operand" "")
   (match_operand:V2SI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vmulsidi3v (operands[0], operands[1], operands[2],
			    GEN_INT (0), GEN_INT (0)));
  DONE;
}
[(set_attr "type" "dmul")])
...
(define_insn "mulsidi3v"
  [(set (match_operand:DI 0 "register_operand"                  "=  r,   r,   r,   r")
	(mult:DI
	  (sign_extend:DI
	     (vec_select:SI
	       (subreg:V2SI (match_operand:DI 1 "register_operand"         "   r,   r,   r,   r") 0)
	       (parallel [(match_operand:SI 3 "imm_0_1_operand" " M00, M00, M01, M01")])))
	  (sign_extend:DI (vec_select:SI
	       (subreg:V2SI (match_operand:DI 2 "register_operand"         "   r,   r,   r,   r") 0)
	       (parallel [(match_operand:SI 4 "imm_0_1_operand" " M00, M01, M01, M00")])))))]
  "TARGET_DSP && TARGET_64BIT"
{
...
(define_expand "vkmabb"
  ...
  "TARGET_DSP && !TARGET_64BIT"
{
  emit_insn (gen_vkma_internal (operands[0], operands[2], operands[3],
			       GEN_INT (0), GEN_INT (0),
			       operands[1]));
  DONE;
}
...
(define_expand "vkmabb64"
  ...
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vkma64_internal (operands[0], operands[2], operands[3],
				 GEN_INT (0), GEN_INT (2), GEN_INT (0),
				 GEN_INT (2), operands[1]));
  DONE;
}
  ...
  [(set (match_operand:V2SI 0 "register_operand"                 "=   r,   r,   r,   r")
	(ss_plus:V2SI
	  (mult:V2SI
	    (sign_extend:V2SI
	      (vec_select:V2HI
		(subreg:V4HI (match_operand:DI 1 "register_operand"         "   r,   r,   r,   r") 0)
	        (parallel [(match_operand:SI 3 "imm_0_1_operand" " M00, M00, M01, M01")
			   (match_operand:SI 4 "imm_2_3_operand" " M02, M02, M03, M03")])))
	    (sign_extend:V2SI
	      (vec_select:V2HI
	    (subreg:V4HI (match_operand:DI 2 "register_operand"         "   r,   r,   r,   r") 0)
	        (parallel [(match_operand:SI 5 "imm_0_1_operand" " M00, M01, M01, M00")
			   (match_operand:SI 6 "imm_2_3_operand" " M02, M03, M03, M02")]))))
...
(define_expand "vkmabb32"
  ...
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vkma32_internal (operands[0], operands[2], operands[3],
				 GEN_INT (0), GEN_INT (0),
				 operands[1]));
  DONE;
}
...
(define_insn "dsp_smulsi3_highpart"
  [(set (match_operand:SI 0 "register_operand"                       "=r")
	(truncate:SI
	  (lshiftrt:DI
	    (mult:DI
	  ...
	  (lshiftrt:DI
	    (mult:DI
	      ...
	      (sign_extend:DI
	        (vec_select:HI
		  (match_operand:V2HI 2 "register_operand"           "  r,   r")
		  (parallel [(match_operand:SI 3 "imm_0_1_operand"   "M00, M01")]))))
	    (const_int 16))))]
  "TARGET_DSP && !TARGET_64BIT"
{
	...
	(vec_concat:V2SI
	  ...
	  (truncate:SI
		...
		(sign_extend:DI
		  (vec_select:HI
		    (match_dup 2)
		      (parallel [(match_operand:SI 4 "imm_2_3_operand"   "M02, M03")]))))
	      (const_int 16)))))]
  "TARGET_DSP && TARGET_64BIT"
{
  const char *pats[] = { "smmwb\t%0, %1, %2",
	  ...
	  (truncate:SI
		...
		(sign_extend:DI (match_operand:SI 1 "register_operand" "   r,   r,   r,   r"))
		  (sign_extend:DI
		    (vec_select:HI
		      (match_operand:V2HI 2 "register_operand"         "   r,   r,   r,   r")
		      (parallel [(match_operand:SI 3 "imm_0_1_operand" " M00, M01, M00, M01")]))))
	      (match_operand:SI 5 "imm_15_16_operand"                  " M16, M16, M15, M15" )))))]
  "TARGET_DSP && !TARGET_64BIT"
  "@
  kmmawb\t%0, %1, %2
  kmmawt\t%0, %1, %2
	  ...
	  (truncate:SI
		...
		(sign_extend:DI
		  (vec_select:HI
		    (match_operand:V4HI 2 "register_operand"           "  r,   r,   r,   r")
		      (parallel [(match_operand:SI 3 "imm_0_1_operand" "M00, M01, M00, M01")]))))
	      (match_operand:SI 6 "imm_15_16_operand"                  "M16, M16, M15, M15")))
	  (truncate:SI
	    (lshiftrt:DI
	      (mult:DI
		(sign_extend:DI
		...
		(sign_extend:DI
		  (vec_select:HI
		    (match_dup 2)
		      (parallel [(match_operand:SI 4 "imm_2_3_operand" "M02, M03, M02, M03")]))))
	      (match_dup 6))))))]
  "TARGET_DSP && TARGET_64BIT"
  "@
  kmmawb\t%0, %1, %2
	...
	(plus:DI
	  ...
	  (mult:DI
	    (sign_extend:DI
	      (vec_select:HI
		(match_operand:V2HI 1 "register_operand"         "   r,   r,   r,   r")
		(parallel [(match_operand:SI 4 "imm_0_1_operand" " M00, M00, M01, M01")])))
	    (sign_extend:DI
	      (vec_select:HI
		(match_operand:V2HI 2 "register_operand"         "   r,   r,   r,   r")
		(parallel [(match_operand:SI 5 "imm_0_1_operand" " M00, M01, M01, M00")]))))))]
  ...
  [(set (match_operand:DI 0 "register_operand"                   "=  r,   r,   r,   r")
	(plus:DI
	  ...
	  (plus:DI
		...
		(vec_select:HI
		  (match_dup 1)
		  (parallel [(match_operand:SI 6 "imm_2_3_operand" " M02, M02, M03, M03")])))
	      (sign_extend:DI
		(vec_select:HI
		  (match_dup 2)
		  (parallel [(match_operand:SI 7 "imm_2_3_operand" " M02, M03, M03, M02")])))))))]
  "TARGET_DSP && TARGET_64BIT"
  "@
   smalbb\t%0, %1, %2
   smalbt\t%0, %1, %2
...
(define_insn "kssl64"
  [(set (match_operand:DI 0 "register_operand"               "=   r, r")
	(sign_extend:DI (ss_ashift:SI (match_operand:SI 1 "register_operand" "    r, r")
		      (match_operand:SI 2 "rimm5u_operand"   " Iu05, r"))))]
  "TARGET_DSP && TARGET_64BIT"
  "@
   kslliw\t%0, %1, %2
...
(define_insn "<sz>kabs64"
  [(set (match_operand:DI 0 "register_operand" "=r")
	(any_extend:DI (unspec:SI [(match_operand:SI 1 "register_operand" "r")] UNSPEC_KABS)))]
  "TARGET_DSP && TARGET_64BIT"
  "kabsw\t%0, %1"
  [(set_attr "type" "dalu")
   (set_attr "mode" "DI")])
...
(define_insn "kaddh<mode>_1"
  [(set (match_operand:X 0 "register_operand" "=r")
	(sign_extend:X (subreg:HI (unspec:SI [(match_operand:SI 1 "register_operand" "r")
				    (match_operand:SI 2 "register_operand" "r")] UNSPEC_KADDH) 0)))]
  "TARGET_DSP"
  "kaddh\t%0, %1, %2"
  [(set_attr "type" "dalu")
   (set_attr "mode" "<MODE>")])
...
(define_insn "kdmbb<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand" "=r")
	(unspec:DSP_VHI [(match_operand:DSP_VHI 1 "register_operand" "r")
		     (match_operand:DSP_VHI 2 "register_operand" "r")] UNSPEC_KDMBB))]
  "TARGET_DSP"
  "kdmbb\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "<MODE>")])
...
(define_insn "kdmbt<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand" "=r")
	(unspec:DSP_VHI [(match_operand:DSP_VHI 1 "register_operand" "r")
		     (match_operand:DSP_VHI 2 "register_operand" "r")] UNSPEC_KDMBT))]
  "TARGET_DSP"
  "kdmbt\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "<MODE>")])
...
(define_insn "kdmtt<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand" "=r")
	(unspec:DSP_VHI [(match_operand:DSP_VHI 1 "register_operand" "r")
		     (match_operand:DSP_VHI 2 "register_operand" "r")] UNSPEC_KDMTT))]
  "TARGET_DSP"
  "kdmtt\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "<MODE>")])
...
(define_insn "khmbb<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand" "=r")
	(unspec:DSP_VHI [(match_operand:DSP_VHI 1 "register_operand" "r")
		     (match_operand:DSP_VHI 2 "register_operand" "r")] UNSPEC_KHMBB))]
  "TARGET_DSP"
  "khmbb\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "<MODE>")])
...
(define_insn "khmbt<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand" "=r")
	(unspec:DSP_VHI [(match_operand:DSP_VHI 1 "register_operand" "r")
		     (match_operand:DSP_VHI 2 "register_operand" "r")] UNSPEC_KHMBT))]
  "TARGET_DSP"
  "khmbt\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "<MODE>")])
...
(define_insn "khmtt<mode>"
  [(set (match_operand:DSP_VHI 0 "register_operand" "=r")
	(unspec:DSP_VHI [(match_operand:DSP_VHI 1 "register_operand" "r")
		     (match_operand:DSP_VHI 2 "register_operand" "r")] UNSPEC_KHMTT))]
  "TARGET_DSP"
  "khmtt\t%0, %1, %2"
  [(set_attr "type" "dmul")
   (set_attr "mode" "<MODE>")])
...
(define_expand "<shift><mode>3"
  [(set (match_operand:DSP_VQI 0 "register_operand"                "")
	(any_shift:DSP_VQI (match_operand:DSP_VQI 1 "register_operand" "")
...
(define_insn "*ashl<mode>3"
  [(set (match_operand:DSP_VQI 0 "register_operand"             "=  r, r")
	(ashift:DSP_VQI (match_operand:DSP_VQI 1 "register_operand" "   r, r")
...
(define_insn "kslli8<DSP_VQI:mode><X:mode>"
  [(set (match_operand:DSP_VQI 0 "register_operand"                "=  r, r")
	(ss_ashift:DSP_VQI (match_operand:DSP_VQI 1 "register_operand" "   r, r")
  ...
  "@
   ...
   ksll8\t%0, %1, %2"
  [(set_attr "type" "dalu, dalu")
   (set_attr "mode" "<DSP_VQI:MODE>, <DSP_VQI:MODE>")])

(define_insn "*ashr<mode>3"
  [(set (match_operand:DSP_VQI 0 "register_operand"               "=  r, r")
	(ashiftrt:DSP_VQI (match_operand:DSP_VQI 1 "register_operand" "   r, r")
		       (match_operand:SI 2 "rimm3u_operand"   " u03, r")))]
  "TARGET_DSP"
  "@
   srai8\t%0, %1, %2
...
(define_insn "sra8_round<mode>"
  [(set (match_operand:DSP_VQI 0 "register_operand"                            "=  r, r")
	(unspec:DSP_VQI [(ashiftrt:DSP_VQI (match_operand:DSP_VQI 1 "register_operand" "   r, r")
				   (match_operand:SI 2  "rimm3u_operand"   " u03, r"))]
		      UNSPEC_ROUND))]
  "TARGET_DSP"
  "@
...
(define_insn "*lshr<mode>3"
  [(set (match_operand:DSP_VQI 0 "register_operand"               "=  r, r")
	(lshiftrt:DSP_VQI (match_operand:DSP_VQI 1 "register_operand" "   r, r")
		       (match_operand:SI 2 "rimm3u_operand"   " u03, r")))]
  "TARGET_DSP"
  "@
   srli8\t%0, %1, %2
...
(define_insn "srl8_round<mode>"
  [(set (match_operand:DSP_VQI 0 "register_operand"                            "=  r, r")
	(unspec:DSP_VQI [(lshiftrt:DSP_VQI (match_operand:DSP_VQI 1 "register_operand" "   r, r")
				   (match_operand:SI 2  "rimm3u_operand"   " u03, r"))]
		      UNSPEC_ROUND))]
  "TARGET_DSP"
  "@
...
(define_insn "maddr32_3"
  [(set (match_operand:DI 0 "register_operand"                   "=r")
	(sign_extend:DI (plus:SI (match_operand:SI 3 "register_operand"          " 0")
		 (mult:SI (match_operand:SI 1 "register_operand" " r")
			  (match_operand:SI 2 "register_operand" " r")))))]
  "TARGET_64BIT && TARGET_DSP"
  "maddr32\t%0, %1, %2"
...
(define_expand "vkdmabb64"
  ...
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vkdma64_internal (operands[0], operands[2], operands[3],
				  GEN_INT (0), GEN_INT (0), operands[1]));
  DONE;
}
[(set_attr "type" "dmac")])
...
(define_expand "kdmabb16"
  ...
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_kdma16_internal (operands[0], operands[2], operands[3],
...
(define_expand "vkdmabb16"
  ...
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vkdma16_internal (operands[0], operands[2], operands[3],
				 GEN_INT (0), GEN_INT (0), GEN_INT (2),
				 GEN_INT (2), operands[1]));
  DONE;
}
  ...
  [(set (match_operand:DI 0 "register_operand"                      "=   r,   r,   r,   r")
	(ss_plus:DI
	  (vec_concat:DI
		...
		(sign_extend:SI
		  (vec_select:HI
		    (subreg:V4HI (match_dup 1) 0)
		    (parallel [(match_operand:SI 5 "imm_2_3_operand"  " M02, M02, M03, M03")])))
		(sign_extend:SI
		  (vec_select:HI
		    (subreg:V4HI (match_dup 2) 0)
		    (parallel [(match_operand:SI 6 "imm_2_3_operand"  " M02, M03, M03, M02")]))))
	      (const_int 1)))
	  (match_operand:DI 7 "register_operand"                    "   0,   0,   0,   0")))]
  "TARGET_DSP && TARGET_64BIT"
  "@
   kdmabb16\t%0, %1, %2
   kdmabt16\t%0, %1, %2
...
(define_expand "vsmaqa"
  ...
  "TARGET_DSP && !TARGET_64BIT"
{
  emit_insn (gen_vsmaqav4qi (operands[0], operands[1],
			    operands[2], operands[3]));
  DONE;
}
[(set_attr "type" "dmac")])
...
(define_expand "vumaqa"
  ...
  "TARGET_DSP && !TARGET_64BIT"
{
  emit_insn (gen_vumaqav4qi (operands[0], operands[1],
			    operands[2], operands[3]));
  DONE;
}
[(set_attr "type" "dmac")])
  ...
  [(set (match_operand:SI 0 "register_operand"             "=r")
	(plus:SI (match_operand:SI 1 "register_operand"    " 0")
	  (plus:SI (plus:SI
		...
		(any_extend:HI
		  (vec_select:QI
		    (subreg:V4QI (match_operand:SI 2 "register_operand" "r") 0)
		    (parallel [(const_int 0)])))
		(any_extend:HI
		  (vec_select:QI
		    (subreg:V4QI (match_operand:SI 3 "register_operand" "r") 0)
		    (parallel [(const_int 0)])))))
	    (sign_extend:SI
	      (mult:HI
		(any_extend:HI (vec_select:QI (subreg:V4QI (match_dup 2) 0) (parallel [(const_int 1)])))
		(any_extend:HI (vec_select:QI (subreg:V4QI (match_dup 3) 0)(parallel [(const_int 1)]))))))
	  (plus:SI
	    (sign_extend:SI
	      (mult:HI
		(any_extend:HI (vec_select:QI (subreg:V4QI (match_dup 2) 0)(parallel [(const_int 2)])))
		(any_extend:HI (vec_select:QI (subreg:V4QI (match_dup 3) 0)(parallel [(const_int 2)])))))
	    (sign_extend:SI
	      (mult:HI
		(any_extend:HI (vec_select:QI (subreg:V4QI (match_dup 2) 0)(parallel [(const_int 3)])))
		(any_extend:HI (vec_select:QI (subreg:V4QI (match_dup 3) 0)(parallel [(const_int 3)])))))))))]
  "TARGET_DSP && !TARGET_64BIT"
  "<su>maqa\t%0, %2, %3"
  [(set_attr "type" "dmac")
   (set_attr "mode" "SI")])

(define_insn "v<su>maqav4qi"
  [(set (match_operand:SI 0 "register_operand"             "=r")
	(plus:SI (match_operand:SI 1 "register_operand"    " 0")
	  (plus:SI (plus:SI
	    (sign_extend:SI
...
(define_expand "vsmaqa64"
  ...
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vsmaqav8qi (operands[0], operands[1],
			    operands[2], operands[3]));
  DONE;
}
[(set_attr "type" "dmac")])
...
(define_expand "vumaqa64"
  ...
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vumaqav8qi (operands[0], operands[1],
			    operands[2], operands[3]));
  DONE;
}
[(set_attr "type" "dmac")])
...
(define_insn "<su>maqav8qi"
  [(set (subreg:V2SI (match_operand:DI 0 "register_operand"             "=r") 0)
	(plus:V2SI (subreg:V2SI (match_operand:DI 1 "register_operand"  "0") 0)
	  (vec_concat:V2SI
	    (plus:SI
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI
		      (vec_select:QI
			(subreg:V8QI (match_operand:DI 2 "register_operand" "r") 0)
			(parallel [(const_int 0)])))
		    (any_extend:HI
		      (vec_select:QI
			(subreg:V8QI (match_operand:DI 3 "register_operand" "r") 0)
			(parallel [(const_int 0)])))))
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0) (parallel [(const_int 1)])))
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0) (parallel [(const_int 1)]))))))
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0) (parallel [(const_int 2)])))
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0) (parallel [(const_int 2)])))))
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0) (parallel [(const_int 3)])))
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0) (parallel [(const_int 3)])))))))
	    (plus:SI
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0) (parallel [(const_int 4)])))
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0) (parallel [(const_int 4)])))))
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0) (parallel [(const_int 5)])))
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0) (parallel [(const_int 5)]))))))
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0) (parallel [(const_int 6)])))
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0) (parallel [(const_int 6)])))))
		(sign_extend:SI
		  (mult:HI
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0) (parallel [(const_int 7)])))
		    (any_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0) (parallel [(const_int 7)]))))))))))]
  "TARGET_DSP && TARGET_64BIT"
  "<su>maqa\t%0, %2, %3"
  [(set_attr "type" "dmac")
   (set_attr "mode" "V2SI")])

(define_insn "v<su>maqav8qi"
  [(set (match_operand:V2SI 0 "register_operand"             "=r")
...
(define_expand "vsumaqa"
  ...
  "TARGET_DSP && !TARGET_64BIT"
{
  emit_insn (gen_vsumaqav4qi (operands[0], operands[1],
			     operands[2], operands[3]));
  DONE;
}
[(set_attr "type" "dmac")])
  ...
  [(set (match_operand:SI 0 "register_operand"             "=r")
	(plus:SI (match_operand:SI 1 "register_operand"    " 0")
	  (plus:SI (plus:SI
		...
		(sign_extend:HI
		  (vec_select:QI
		    (subreg:V4QI (match_operand:V4QI 2 "register_operand" "r") 0)
		    (parallel [(const_int 0)])))
		(zero_extend:HI
		  (vec_select:QI
		    (subreg:V4QI (match_operand:V4QI 3 "register_operand" "r") 0)
		    (parallel [(const_int 0)])))))
	    (sign_extend:SI
	      (mult:HI
		(sign_extend:HI (vec_select:QI (subreg:V4QI (match_dup 2) 0)(parallel [(const_int 1)])))
		(zero_extend:HI (vec_select:QI (subreg:V4QI (match_dup 3) 0)(parallel [(const_int 1)]))))))

	  (plus:SI
	    (sign_extend:SI
	      (mult:HI
		(sign_extend:HI (vec_select:QI (subreg:V4QI (match_dup 2) 0)(parallel [(const_int 2)])))
		(zero_extend:HI (vec_select:QI (subreg:V4QI (match_dup 3) 0)(parallel [(const_int 2)])))))
	    (sign_extend:SI
	      (mult:HI
		(sign_extend:HI (vec_select:QI (subreg:V4QI (match_dup 2) 0)(parallel [(const_int 3)])))
		(zero_extend:HI (vec_select:QI (subreg:V4QI (match_dup 3) 0)(parallel [(const_int 3)])))))))))]
  "TARGET_DSP && !TARGET_64BIT"
  "smaqa.su\t%0, %2, %3"
  [(set_attr "type" "dmac")
   (set_attr "mode" "SI")])

(define_insn "vsumaqav4qi"
  [(set (match_operand:SI 0 "register_operand"             "=r")
	(plus:SI (match_operand:SI 1 "register_operand"    " 0")
	  (plus:SI (plus:SI
	    (sign_extend:SI
...
(define_expand "vsumaqa64"
  ...
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vsumaqav8qi (operands[0], operands[1],
			     operands[2], operands[3]));
  DONE;
}
[(set_attr "type" "dmac")])
  ...
  [(set (subreg:V2SI(match_operand:DI 0 "register_operand"             "=r") 0)
	(plus:V2SI (subreg:V2SI (match_operand:DI 1 "register_operand"  " 0") 0)
	  (vec_concat:V2SI
		...
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0)(parallel [(const_int 1)])))
		    (zero_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0)(parallel [(const_int 1)]))))))
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0)(parallel [(const_int 2)])))
		    (zero_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0)(parallel [(const_int 2)])))))
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0)(parallel [(const_int 3)])))
		    (zero_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0)(parallel [(const_int 3)])))))))
	    (plus:SI
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0)(parallel [(const_int 4)])))
		    (zero_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0)(parallel [(const_int 4)])))))
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0)(parallel [(const_int 5)])))
		    (zero_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0)(parallel [(const_int 5)]))))))
	      (plus:SI
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0)(parallel [(const_int 6)])))
		    (zero_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0)(parallel [(const_int 6)])))))
		(sign_extend:SI
		  (mult:HI
		    (sign_extend:HI (vec_select:QI (subreg:V8QI (match_dup 2) 0)(parallel [(const_int 7)])))
		    (zero_extend:HI (vec_select:QI (subreg:V8QI (match_dup 3) 0)(parallel [(const_int 7)]))))))))))]
  "TARGET_DSP && TARGET_64BIT"
  "smaqa.su\t%0, %2, %3"
  [(set_attr "type" "dmac")
   (set_attr "mode" "V2SI")])

(define_insn "vsumaqav8qi"
  [(set (match_operand:V2SI 0 "register_operand"             "=r")
	(plus:V2SI (match_operand:V2SI 1 "register_operand"  " 0")
	  (vec_concat:V2SI
	    (plus:SI
...
(define_expand "vstas16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vstas16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
	  ...
	  (vec_concat:V2HI
	    (minus:HI (vec_select:HI (subreg:V4HI (match_operand:DI 1 "register_operand" " r") 0)
		      ...
		      (vec_select:HI (subreg:V4HI (match_operand:DI 2 "register_operand" " r") 0)
				     (parallel [(const_int 0)])))
	    (plus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)]))
		     (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 1)]))))
	  (vec_concat:V2HI
	    (minus:HI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 2)]))
		      (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 2)])))
	    (plus:HI  (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 3)]))
...
(define_expand "vkstas16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vkstas16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_expand "vukstas16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP"
{
  emit_insn (gen_vukstas16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_expand "vstsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vstsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_expand "vkstsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vkstsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_expand "vukstsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vukstsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_expand "vrstas16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vrstas16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
  ...
  [(set (subreg:V4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:V4HI
	  (vec_concat:V2HI
		...
		(plus:SI
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)])))
		  (sign_extend:SI (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 1)]))))
		(const_int 1))))
	  (vec_concat:V2HI
	    (truncate:HI
	      (ashiftrt:SI
...
(define_expand "vurstas16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vurstas16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
  ...
  [(set (subreg:V4HI (match_operand:DI 0 "register_operand"         "=r") 0)
	(vec_concat:V4HI
	  (vec_concat:V2HI
		...
		(plus:SI
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_dup 1) 0)(parallel [(const_int 1)])))
		  (zero_extend:SI (vec_select:HI (subreg:V4HI (match_dup 2) 0)(parallel [(const_int 1)]))))
		(const_int 1))))
	  (vec_concat:V2HI
	    (truncate:HI
	      (lshiftrt:SI
...
(define_expand "vrstsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vrstsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
...
(define_expand "vurstsa16_64"
  [(match_operand:V4HI 0 "register_operand" "")
   (match_operand:V4HI 1 "register_operand" "")
   (match_operand:V4HI 2 "register_operand" "")]
  "TARGET_DSP && TARGET_64BIT"
{
  emit_insn (gen_vurstsa16_64_le (operands[0], operands[1], operands[2]));
  DONE;
}
[(set_attr "type" "dalu")])
