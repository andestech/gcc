...
#define __nds32__cpe1(a, b) \
(__builtin_nds32_cpe1((a), (b)))
#define __nds32__cpe2(a, b) \
(__builtin_nds32_cpe2((a), (b)))
#define __nds32__cpe3(a, b) \
(__builtin_nds32_cpe3((a), (b)))
#define __nds32__cpe4(a, b) \
(__builtin_nds32_cpe4((a), (b)))

#define __nds32__cpld(a, b, c, d, e) \
(__builtin_nds32_cpld((a), (b), (c), (d), (e)))
#define __nds32__cpld_bi(a, b, c, d, e) \
(__builtin_nds32_cpld_bi((a), (b), (c), (d), (e)))
#define __nds32__cpldi(a, b, c, d) \
(__builtin_nds32_cpldi((a), (b), (c), (d)))
#define __nds32__cpldi_bi(a, b, c, d) \
(__builtin_nds32_cpldi_bi((a), (b), (c), (d)))
#define __nds32__cplw(a, b, c, d, e) \
(__builtin_nds32_cplw((a), (b), (c), (d), (e)))
#define __nds32__cplw_bi(a, b, c, d, e) \
(__builtin_nds32_cplw_bi((a), (b), (c), (d), (e)))
#define __nds32__cplwi(a, b, c, d) \
(__builtin_nds32_cplwi((a), (b), (c), (d)))
#define __nds32__cplwi_bi(a, b, c, d) \
(__builtin_nds32_cplwi_bi((a), (b), (c), (d)))
#define __nds32__cpsd(a, b, c, d, e) \
(__builtin_nds32_cpsd((a), (b), (c), (d), (e)))
#define __nds32__cpsd_bi(a, b, c, d, e) \
(__builtin_nds32_cpsd_bi((a), (b), (c), (d), (e)))
#define __nds32__cpsdi(a, b, c, d) \
(__builtin_nds32_cpsdi((a), (b), (c), (d)))
#define __nds32__cpsdi_bi(a, b, c, d) \
(__builtin_nds32_cpsdi_bi((a), (b), (c), (d)))
#define __nds32__cpsw(a, b, c, d, e) \
(__builtin_nds32_cpsw((a), (b), (c), (d), (e)))
#define __nds32__cpsw_bi(a, b, c, d, e) \
(__builtin_nds32_cpsw_bi((a), (b), (c), (d), (e)))
#define __nds32__cpswi(a, b, c, d) \
(__builtin_nds32_cpswi((a), (b), (c), (d)))
#define __nds32__cpswi_bi(a, b, c, d) \
(__builtin_nds32_cpswi_bi((a), (b), (c), (d)))
#define __nds32__mfcpd(a, b) \
(__builtin_nds32_mfcpd((a), (b)))
#define __nds32__mfcpw(a, b) \
(__builtin_nds32_mfcpw((a), (b)))
#define __nds32__mfcppw(a, b) \
(__builtin_nds32_mfcppw((a), (b)))
#define __nds32__mtcpd(a, b, c) \
(__builtin_nds32_mtcpd((a), (b), (c)))
#define __nds32__mtcpw(a, b, c) \
(__builtin_nds32_mtcpw((a), (b), (c)))
#define __nds32__mtcppw(a, b, c) \
(__builtin_nds32_mtcppw((a), (b), (c)))
