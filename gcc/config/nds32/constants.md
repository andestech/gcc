...
(define_c_enum "unspec_volatile_element" [
  ...
  UNSPEC_VOLATILE_CPE1
  UNSPEC_VOLATILE_CPE2
  UNSPEC_VOLATILE_CPE3
  UNSPEC_VOLATILE_CPE4
  UNSPEC_VOLATILE_CPLD
  UNSPEC_VOLATILE_CPLD_BI
  UNSPEC_VOLATILE_CPLDI
  UNSPEC_VOLATILE_CPLDI_BI
  UNSPEC_VOLATILE_CPLW
  UNSPEC_VOLATILE_CPLW_BI
  UNSPEC_VOLATILE_CPLWI
  UNSPEC_VOLATILE_CPLWI_BI
  UNSPEC_VOLATILE_CPSD
  UNSPEC_VOLATILE_CPSD_BI
  UNSPEC_VOLATILE_CPSDI
  UNSPEC_VOLATILE_CPSDI_BI
  UNSPEC_VOLATILE_CPSW
  UNSPEC_VOLATILE_CPSW_BI
  UNSPEC_VOLATILE_CPSWI
  UNSPEC_VOLATILE_CPSWI_BI
  UNSPEC_VOLATILE_MFCPD
  UNSPEC_VOLATILE_MFCPW
  UNSPEC_VOLATILE_MFCPPW
  UNSPEC_VOLATILE_MTCPD
  UNSPEC_VOLATILE_MTCPW
  UNSPEC_VOLATILE_MTCPPW
])
