...
extern bool nds32_gw_ex_to_ex_p (rtx, rtx);
...
rtx prev_executable_insn (rtx);
rtx next_executable_insn (rtx);
rtx prev_executable_insn_local (rtx);
rtx next_executable_insn_local (rtx);
