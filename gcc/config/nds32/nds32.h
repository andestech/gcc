...
struct GTY(()) machine_function
{
  ...
  /* Record no_ex9 and no_ifc attriubtes.  */
  int attr_no_ex9;
  int attr_no_ifc;
...
enum nds32_builtins
{
  ...
  NDS32_BUILTIN_CPE4,
  NDS32_BUILTIN_CPLD,
  NDS32_BUILTIN_CPLD_BI,
  NDS32_BUILTIN_CPLDI,
  NDS32_BUILTIN_CPLDI_BI,
  NDS32_BUILTIN_CPLW,
  NDS32_BUILTIN_CPLW_BI,
  NDS32_BUILTIN_CPLWI,
  NDS32_BUILTIN_CPLWI_BI,
  NDS32_BUILTIN_CPSD,
  NDS32_BUILTIN_CPSD_BI,
  NDS32_BUILTIN_CPSDI,
  NDS32_BUILTIN_CPSDI_BI,
  NDS32_BUILTIN_CPSW,
  NDS32_BUILTIN_CPSW_BI,
  NDS32_BUILTIN_CPSWI,
  NDS32_BUILTIN_CPSWI_BI,
  NDS32_BUILTIN_MFCPD,
  NDS32_BUILTIN_MFCPW,
  NDS32_BUILTIN_MFCPPW,
  NDS32_BUILTIN_MTCPD,
  NDS32_BUILTIN_MTCPW,
  NDS32_BUILTIN_MTCPPW,
  NDS32_BUILTIN_COUNT
};
...
#  define NDS32_IFC_SPEC " %{Os2|Os3|Os|mifc:%{!mno-ifc:--mifc}}"
#else
#  define NDS32_IFC_SPEC " %{mifc:--mifc}"
#endif
#define NDS32_IFC_V3M_PLUS_SPEC " %{march=v3m+:%{Os2|Os3|Os|mifc:%{!mno-ifc:-mifc}}}"

#ifdef TARGET_OS_DEFAULT_EX9
#  define NDS32_EX9_SPEC " %{Os2|Os3|Os|mex9:%{!mno-ex9:--mex9}}"
#else
#  define NDS32_EX9_SPEC " %{mex9:--mex9}"
#endif
#define NDS32_EX9_V3M_PLUS_SPEC " %{march=v3m+:%{Os2|Os3|Os|mex9:%{!mno-ex9:-mex9}}}"
