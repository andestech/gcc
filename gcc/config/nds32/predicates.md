...
(define_predicate "nds32_imm12s_operand"
  (and (match_operand 0 "const_int_operand")
       (match_test "satisfies_constraint_Is12 (op)")))
...
(define_predicate "nds32_imm12u_operand"
  (and (match_operand 0 "const_int_operand")
       (match_test "satisfies_constraint_Iu12 (op)")))

(define_predicate "nds32_imm19u_operand"
  (and (match_operand 0 "const_int_operand")
       (match_test "satisfies_constraint_Iu19 (op)")))
