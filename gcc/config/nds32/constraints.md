...
(define_constraint "Iu12"
  "Unsigned immediate 12-bit value"
  (and (match_code "const_int")
       (match_test "ival < (1 << 12) && ival >= 0")))

(define_constraint "Iu19"
  "Unsigned immediate 19-bit value"
  (and (match_code "const_int")
       (match_test "ival < (1 << 19) && ival >= 0")))
...
(define_constraint "Is12"
  "Signed immediate 12-bit value"
  (and (match_code "const_int")
       (match_test "ival < (1 << 11) && ival >= -(1 << 11)")))
