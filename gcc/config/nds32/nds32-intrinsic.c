...
static rtx
nds32_expand_cop_2arg_builtin (enum insn_code icode, tree exp, rtx target,
			       bool return_p, const char *name)
{
  rtx pat;
  rtx op0 = nds32_read_argument (exp, 0);
  ...
  if (!nds32_check_constant_argument (icode, op0_num, op0, name)
      || !nds32_check_constant_argument (icode, op1_num, op1, name))
    return NULL_RTX;
...
static rtx
nds32_expand_cop_3arg_builtin (enum insn_code icode, tree exp, rtx target,
			       bool return_p, const char *name)
{
  rtx pat;
  rtx op0 = nds32_read_argument (exp, 0);
  ...
  if (!nds32_check_constant_argument (icode, op0_num, op0, name)
      || !nds32_check_constant_argument (icode, op2_num, op2, name))
    return NULL_RTX;
...
static rtx
nds32_expand_cop_4arg_builtin (enum insn_code icode, tree exp, rtx target,
			       bool return_p, const char *name)
{
  rtx pat;
  rtx op0 = nds32_read_argument (exp, 0);
  rtx op1 = nds32_read_argument (exp, 1);
  rtx op2 = nds32_read_argument (exp, 2);
  rtx op3 = nds32_read_argument (exp, 3);

  int op0_num = return_p ? 1 : 0;
  int op1_num = return_p ? 2 : 1;
  int op2_num = return_p ? 3 : 2;
  int op3_num = return_p ? 4 : 3;
  ...
  if (!nds32_check_constant_argument (icode, op0_num, op0, name)
      || !nds32_check_constant_argument (icode, op1_num, op1, name)
      || !nds32_check_constant_argument (icode, op3_num, op3, name))
    return NULL_RTX;

  op0 = nds32_legitimize_argument (icode, op0_num, op0);
  op1 = nds32_legitimize_argument (icode, op1_num, op1);
  op2 = nds32_legitimize_argument (icode, op2_num, op2);
  op3 = nds32_legitimize_argument (icode, op3_num, op3);
...
static rtx
nds32_expand_cop_5arg_builtin (enum insn_code icode, tree exp, rtx target,
			       bool return_p, const char *name)
{
  rtx pat;
  rtx op0 = nds32_read_argument (exp, 0);
  ...
  rtx op2 = nds32_read_argument (exp, 2);
  rtx op3 = nds32_read_argument (exp, 3);
  rtx op4 = nds32_read_argument (exp, 4);

  int op0_num = return_p ? 1 : 0;
  int op1_num = return_p ? 2 : 1;
  int op2_num = return_p ? 3 : 2;
  int op3_num = return_p ? 4 : 3;
  int op4_num = return_p ? 5 : 4;
  ...
  if (!nds32_check_constant_argument (icode, op0_num, op0, name)
      || !nds32_check_constant_argument (icode, op1_num, op1, name)
      || !nds32_check_constant_argument (icode, op4_num, op4, name))
    return NULL_RTX;
  ...
  op2 = nds32_legitimize_argument (icode, op2_num, op2);
  op3 = nds32_legitimize_argument (icode, op3_num, op3);
  op4 = nds32_legitimize_argument (icode, op4_num, op4);
...
static struct builtin_description bdesc_1arg[] =
{
  ...
  NDS32_BUILTIN(unaligned_loadhi, "unaligned_load_hw", UALOAD_HW)
...
static struct builtin_description bdesc_2arg[] =
{
  ...
  NDS32_NO_TARGET_BUILTIN(unaligned_storehi, "unaligned_store_hw", UASTORE_HW)
...
static struct builtin_description bdesc_cop_2arg[] =
{
  NDS32_NO_TARGET_BUILTIN(cpe1, "cpe1", CPE1)
  NDS32_NO_TARGET_BUILTIN(cpe2, "cpe2", CPE2)
  NDS32_NO_TARGET_BUILTIN(cpe3, "cpe3", CPE3)
  NDS32_NO_TARGET_BUILTIN(cpe4, "cpe4", CPE4)
  NDS32_BUILTIN(mfcpd, "mfcpd", MFCPD)
  NDS32_BUILTIN(mfcpw, "mfcpw", MFCPW)
  NDS32_BUILTIN(mfcppw, "mfcppw", MFCPPW)
};

static struct builtin_description bdesc_cop_3arg[] =
{
  NDS32_NO_TARGET_BUILTIN(mtcpd, "mtcpd", MTCPD)
  NDS32_NO_TARGET_BUILTIN(mtcpw, "mtcpw", MTCPW)
  NDS32_NO_TARGET_BUILTIN(mtcppw, "mtcppw", MTCPPW)
};

static struct builtin_description bdesc_cop_4arg[] =
{
  NDS32_NO_TARGET_BUILTIN(cpldi, "cpldi", CPLDI)
  NDS32_NO_TARGET_BUILTIN(cpldi_bi, "cpldi_bi", CPLDI_BI)
  NDS32_NO_TARGET_BUILTIN(cplwi, "cplwi", CPLWI)
  NDS32_NO_TARGET_BUILTIN(cplwi_bi, "cplwi_bi", CPLWI_BI)
  NDS32_NO_TARGET_BUILTIN(cpsdi, "cpsdi", CPSDI)
  NDS32_NO_TARGET_BUILTIN(cpsdi_bi, "cpsdi_bi", CPSDI_BI)
  NDS32_NO_TARGET_BUILTIN(cpswi, "cpswi", CPSWI)
  NDS32_NO_TARGET_BUILTIN(cpswi_bi, "cpswi_bi", CPSWI_BI)
};

static struct builtin_description bdesc_cop_5arg[] =
{
  NDS32_NO_TARGET_BUILTIN(cpld, "cpld", CPLD)
  NDS32_NO_TARGET_BUILTIN(cpld_bi, "cpld_bi", CPLD_BI)
  NDS32_NO_TARGET_BUILTIN(cplw, "cplw", CPLW)
  NDS32_NO_TARGET_BUILTIN(cplw_bi, "cplw_bi", CPLW_BI)
  NDS32_NO_TARGET_BUILTIN(cpsd, "cpsd", CPSD)
  NDS32_NO_TARGET_BUILTIN(cpsd_bi, "cpsd_bi", CPSD_BI)
  NDS32_NO_TARGET_BUILTIN(cpsw, "cpsw", CPSW)
  NDS32_NO_TARGET_BUILTIN(cpsw_bi, "cpsw_bi", CPSW_BI)
};
			   ...
			   int ignore ATTRIBUTE_UNUSED)
{
  ...
  for (i = 0, d = bdesc_cop_2arg; i < ARRAY_SIZE (bdesc_cop_2arg); i++, d++)
    if (d->code == fcode)
      return nds32_expand_cop_2arg_builtin (d->icode, exp, target,
					    d->return_p, d->name);

  for (i = 0, d = bdesc_cop_3arg; i < ARRAY_SIZE (bdesc_cop_3arg); i++, d++)
    if (d->code == fcode)
      return nds32_expand_cop_3arg_builtin (d->icode, exp, target,
					    d->return_p, d->name);

  for (i = 0, d = bdesc_cop_4arg; i < ARRAY_SIZE (bdesc_cop_4arg); i++, d++)
    if (d->code == fcode)
      return nds32_expand_cop_4arg_builtin (d->icode, exp, target,
					    d->return_p, d->name);

  for (i = 0, d = bdesc_cop_5arg; i < ARRAY_SIZE (bdesc_cop_5arg); i++, d++)
    if (d->code == fcode)
      return nds32_expand_cop_5arg_builtin (d->icode, exp, target,
					    d->return_p, d->name);
  return NULL_RTX;
}
...
#define ADD_NDS32_BUILTIN4(NAME, RET_TYPE, ARG_TYPE1, ARG_TYPE2, \
			   ARG_TYPE3, ARG_TYPE4, CODE) \
  nds32_builtin_decls[NDS32_BUILTIN_ ## CODE] =				\
  add_builtin_function ("__builtin_nds32_" NAME,			\
			build_function_type_list (RET_TYPE##_type_node,	\
						  ARG_TYPE1##_type_node,\
...
#define ADD_NDS32_BUILTIN5(NAME, RET_TYPE, ARG_TYPE1, ARG_TYPE2, \
			   ARG_TYPE3, ARG_TYPE4, ARG_TYPE5, CODE) \
  nds32_builtin_decls[NDS32_BUILTIN_ ## CODE] =				\
  add_builtin_function ("__builtin_nds32_" NAME,			\
			build_function_type_list (RET_TYPE##_type_node,	\
						  ARG_TYPE1##_type_node,\
  ...
  /* Coprocessor */
  ADD_NDS32_BUILTIN2 ("cpe1", void, unsigned, unsigned, CPE1);
  ADD_NDS32_BUILTIN2 ("cpe2", void, unsigned, unsigned, CPE2);
  ADD_NDS32_BUILTIN2 ("cpe3", void, unsigned, unsigned, CPE3);
  ADD_NDS32_BUILTIN2 ("cpe4", void, unsigned, unsigned, CPE4);
  ADD_NDS32_BUILTIN5 ("cpld", void, unsigned, unsigned, ptr_ulong,
		      unsigned, integer, CPLD);
  ADD_NDS32_BUILTIN5 ("cpld_bi", void, unsigned, unsigned, ptr_ulong,
		      unsigned, integer, CPLD_BI);
  ADD_NDS32_BUILTIN4 ("cpldi", void, unsigned, unsigned, ptr_ulong, integer, CPLDI);
  ADD_NDS32_BUILTIN4 ("cpldi_bi", void, unsigned, unsigned, ptr_ulong, integer, CPLDI_BI);
  ADD_NDS32_BUILTIN5 ("cplw", void, unsigned, unsigned, ptr_uint,
		      unsigned, integer, CPLW);
  ADD_NDS32_BUILTIN5 ("cplw_bi", void, unsigned, unsigned, ptr_uint,
		      unsigned, integer, CPLW_BI);
  ADD_NDS32_BUILTIN4 ("cplwi", void, unsigned, unsigned, ptr_uint, integer, CPLWI);
  ADD_NDS32_BUILTIN4 ("cplwi_bi", void, unsigned, unsigned, ptr_uint, integer, CPLWI_BI);
  ADD_NDS32_BUILTIN5 ("cpsd", void, unsigned, unsigned, ptr_ulong,
		      unsigned, integer, CPSD);
  ADD_NDS32_BUILTIN5 ("cpsd_bi", void, unsigned, unsigned, ptr_ulong,
		      unsigned, integer, CPSD_BI);
  ADD_NDS32_BUILTIN4 ("cpsdi", void, unsigned, unsigned, ptr_ulong, integer, CPSDI);
  ADD_NDS32_BUILTIN4 ("cpsdi_bi", void, unsigned, unsigned, ptr_ulong, integer, CPSDI_BI);
  ADD_NDS32_BUILTIN5 ("cpsw", void, unsigned, unsigned, ptr_uint,
		      unsigned, integer, CPSW);
  ADD_NDS32_BUILTIN5 ("cpsw_bi", void, unsigned, unsigned, ptr_uint,
		      unsigned, integer, CPSW_BI);
  ADD_NDS32_BUILTIN4 ("cpswi", void, unsigned, unsigned, ptr_uint, integer, CPSWI);
  ADD_NDS32_BUILTIN4 ("cpswi_bi", void, unsigned, unsigned, ptr_uint, integer, CPSWI_BI);
  ADD_NDS32_BUILTIN2 ("mfcpd", long_long_unsigned, unsigned, unsigned, MFCPD);
  ADD_NDS32_BUILTIN2 ("mfcpw", unsigned, unsigned, unsigned, MFCPW);
  ADD_NDS32_BUILTIN2 ("mfcppw", unsigned, unsigned, unsigned, MFCPPW);
  ADD_NDS32_BUILTIN3 ("mtcpd", void, unsigned, long_long_unsigned, unsigned, MTCPD);
  ADD_NDS32_BUILTIN3 ("mtcpw", void, unsigned, unsigned, unsigned, MTCPW);
  ADD_NDS32_BUILTIN3 ("mtcppw", void, unsigned, unsigned, unsigned, MTCPPW);
}
/* ------------------------------------------------------------------------ */
