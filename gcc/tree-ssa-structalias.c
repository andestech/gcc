	    ...
	    continue;
         ...
         /* Skip any damaged conditions */
          ...
          if (dump_file)
           {
             ...
             fprintf (dump_file, "  "); print_gimple_stmt (dump_file, call_stmt, 0, dump_flags);
           }
          ...
          if (dump_file)
            {
              fprintf (dump_file, "\n} is modified to {\n\n");
              fprintf (dump_file, "  "); print_gimple_stmt (dump_file, load1_stmt, 0, dump_flags);
              fprintf (dump_file, "  "); print_gimple_stmt (dump_file, store1_stmt, 0, dump_flags);
              fprintf (dump_file, "  "); print_gimple_stmt (dump_file, call_stmt, 0, dump_flags);
              fprintf (dump_file, "  "); print_gimple_stmt (dump_file, load2_stmt, 0, dump_flags);
              fprintf (dump_file, "  "); print_gimple_stmt (dump_file, store2_stmt, 0, dump_flags);
              fprintf (dump_file, "\n}\n\n");
            }
        }
    }
