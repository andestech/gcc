...
unsigned long scmplt8 (unsigned long ra, unsigned long rb)
{
  return __nds__scmplt8 (ra, rb);
}

static __attribute__ ((noinline))
uint8x8_t v_scmplt8 (int8x8_t ra, int8x8_t rb)
{
  return __nds64__v_scmplt8 (ra, rb);
}
...
main ()
{
  ...
  unsigned long a = scmplt8 (0xfefe0101fefe0101, 0xffff0000ffff0000);
