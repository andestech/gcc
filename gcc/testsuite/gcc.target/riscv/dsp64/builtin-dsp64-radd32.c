...
unsigned long radd32 (unsigned long ra, unsigned long rb)
{
  return __nds__radd32 (ra, rb);
}

static __attribute__ ((noinline))
int32x2_t v_radd32 (int32x2_t ra, int32x2_t rb)
{
  return __nds64__v_radd32 (ra, rb);
}
...
main ()
{
  ...
  unsigned long a = radd32 (0x0001f0000001f000, 0x0001100000011000);
