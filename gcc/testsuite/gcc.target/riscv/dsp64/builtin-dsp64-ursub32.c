...
unsigned long ursub32 (unsigned long ra, unsigned long rb)
{
  return __nds__ursub32 (ra, rb);
}

static __attribute__ ((noinline))
uint32x2_t v_ursub32 (uint32x2_t ra, uint32x2_t rb)
{
  return __nds64__v_ursub32 (ra, rb);
}
...
main ()
{
  ...
  unsigned long a = ursub32 (0x0001f0000001f000, 0x0001100000011000);
