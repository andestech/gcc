...
unsigned long srli32u (unsigned long ra)
{
  return __nds__srl32_u (ra, 4);
}
...
main ()
{
  ...
  unsigned long a = srli32u (0x0ffff0000ffff000);
  int32x2_t va = v_srli32u ((int32x2_t) {0x7fff8000, 0x7fff8000});
